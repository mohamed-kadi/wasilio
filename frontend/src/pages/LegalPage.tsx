...
const pages = {
  terms: {
    ...
    path: '/terms',
    description: 'Terms for using Nexora COD operations software during pilot and production use.',
    heading: 'Terms of Service',
    updated: 'June 10, 2026',
    sections: [
      ['Service', 'Nexora provides COD order operations software for merchant teams, including confirmation queues, callback tracking, courier workflow support, tenant administration, and billing support tools.'],
      ['Pilot Access', 'Pilot access may be limited, manually approved, or suspended while Nexora evaluates fit, support capacity, payment status, and operational risk.'],
      ...
      ['Availability', 'Nexora is provided as an early-stage SaaS product. We aim for reliable operation, but maintenance windows, outages, or feature changes may occur during controlled pilots.'],
      ['Acceptable Use', 'Do not use Nexora to process unlawful orders, abuse rate limits, attempt unauthorized access, or interfere with other tenants.'],
  ...
  privacy: {
    ...
    path: '/privacy',
    description: 'Privacy policy for Nexora lead capture and COD merchant operations data.',
    heading: 'Privacy Policy',
    updated: 'June 10, 2026',
    sections: [
      ['Information We Collect', 'Nexora may collect account details, lead form submissions, order and customer records entered by merchants, courier workflow data, payment records, IP addresses, and operational logs.'],
      ...
      ['Lead Capture', 'Demo request forms collect contact name, store name, phone or WhatsApp number, city, order volume, message, and campaign source so Nexora can follow up with prospective pilot clients.'],
  ...
  payment: {
    ...
    description: 'Manual payment and refund policy for Nexora pilot merchants.',
    heading: 'Payment And Refund Policy',
    updated: 'June 10, 2026',
    sections: [
      ['Manual Billing', 'Nexora supports manual billing for pilot merchants, including cash, bank transfer, check, or other agreed payment methods recorded by Nexora operations.'],
      ...
      ['Refunds', 'Refunds, credits, or extensions are reviewed case by case based on service availability, payment period, merchant usage, and written agreement with Nexora operations.'],
