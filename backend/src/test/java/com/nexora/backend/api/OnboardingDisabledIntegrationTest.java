...
@ActiveProfiles("test")
@TestPropertySource(properties = "app.onboarding.enabled=false")
class OnboardingDisabledIntegrationTest {
    ...
    @Test
    void onboardingDisabledReturnsForbidden() throws Exception {
        ...
        mockMvc.perform(post("/api/onboarding/tenants")
